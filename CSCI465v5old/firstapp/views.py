...
def lfg(request):
    form = suggestion_form()
    suggestions = suggestion.objects.filter(choice_field='LFG')
    to_return = []
    for suggest in suggestions:
        data = {}
        data["suggestion"]=suggest.suggestion
...
def lfm(request):
    form = suggestion_form()
    suggestions = suggestion.objects.filter(choice_field='LFM')
    to_return = []
    for suggest in suggestions:
        data = {}
        data["suggestion"]=suggest.suggestion
...
def wtb(request):
    form = suggestion_form()
    suggestions = suggestion.objects.filter(choice_field='WTB')
    to_return = []
    for suggest in suggestions:
        data = {}
        data["suggestion"]=suggest.suggestion
...
def wts(request):
    form = suggestion_form()
    suggestions = suggestion.objects.filter(choice_field='WTS')
    to_return = []
    for suggest in suggestions:
        data = {}
        data["suggestion"]=suggest.suggestion
